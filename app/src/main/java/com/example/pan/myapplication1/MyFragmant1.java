...
public class MyFragmant1 extends Fragment {
    ...
    public static MyFragmant1 newInstance(String param1, String param2) {
        MyFragmant1 fragment = new MyFragmant1();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup viewGroup, Bundle bundle) {
        View v = inflater.inflate(R.layout.my_fragment1, viewGroup, false);
        ...
        private class MyListener1 implements View.OnTouchListener {
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                switch (action) {
                    case MotionEvent.ACTION_DOWN:
                        Drawable s = getResources().getDrawable(R.drawable.group8);
                        bu1.setBackground(s);
                        break;

                    case MotionEvent.ACTION_UP:
                        Drawable s1 = getResources().getDrawable(R.mipmap.sms1);
